...
*Tools:* GitHub's Spec-Kit ([github.com/github/spec-kit](https://github.com/github/spec-kit)), the BMAD-Method ([github.com/bmad-code-org/BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD)), and Matt Pocock's AI Hero ([aihero.dev](https://aihero.dev)), whose `/grill-with-docs` skill makes the Spec Session executable.
...
A running version of this list lives at [leftoftheloop.dev](https://leftoftheloop.dev).
